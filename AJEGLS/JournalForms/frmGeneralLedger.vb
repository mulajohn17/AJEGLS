...
Public Class frmGeneralLedger
    ...
    Public Sub frmGeneralLedger_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'Retrievegeneral.generaltbl' table. You can move, or remove it, as needed.
        Me.GeneraltblTableAdapter.FillgeneralJournal(Me.Retrievegeneral.generaltbl)
        'TODO: This line of code loads data into the 'Retrievegeneral.generaltbl' table. You can move, or remove it, as needed.
        Me.GeneraltblTableAdapter.FillgeneralJournal(Me.Retrievegeneral.generaltbl)
        'TODO: This line of code loads data into the 'CustomerLname.customertbl' table. You can move, or remove it, as needed.
    ...
    Private Sub comboSupplier_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles comboSupplier.KeyPress, comboCustomerSales.KeyPress, cbAccount2.KeyPress, cbChart1.KeyPress, cbCredit.KeyPress, cbDebit.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            SendKeys.Send("{TAB}")
            e.Handled = True
        End If

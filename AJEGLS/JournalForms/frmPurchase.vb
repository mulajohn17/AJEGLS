...
Public Class frmPurchase
    ...
    Public Sub frmPurchase_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'PurchaseRetrieve.puchasejournaltbl' table. You can move, or remove it, as needed.
        Me.PuchasejournaltblTableAdapter.FillpurchaseJournal(Me.PurchaseRetrieve.puchasejournaltbl)
        ...
        With con
            ...
            End If
        End With
        'TODO: This line of code loads data into the 'Supplier.suppliertbl' table. You can move, or remove it, as needed.
        Me.SuppliertblTableAdapter.Fill(Me.Supplier.suppliertbl)
    ...
    Public Sub GenerateID()
        ...
        Dim ar As String = "purchase-"
        Dim s As String
        With cmd
            .CommandType = CommandType.StoredProcedure
            .CommandText = "countpurchase"
            .Connection = con
            .Parameters.Clear()
        End With
    ...
    Private Sub comboSupplier_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles comboSupplier.KeyPress, cbAccount2.KeyPress, cbChart1.KeyPress, cbCredit.KeyPress, cbDebit.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            SendKeys.Send("{TAB}")
            e.Handled = True
        End If
